...
class PostLike(Base):
    ...
    content_id: Mapped[int] = mapped_column(BigInteger, ForeignKey("posts.post_id"))
...
class StoryLike(Base):
    ...
    like_id: Mapped[int] = mapped_column(BigInteger, primary_key=True, autoincrement=True)
    user_id: Mapped[int] = mapped_column(BigInteger, ForeignKey("users.user_id"))
    content_id: Mapped[int] = mapped_column(BigInteger, ForeignKey("stories.story_id"))
    created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow)
...
class CommentLike(Base):
    ...
    like_id: Mapped[int] = mapped_column(BigInteger, primary_key=True, autoincrement=True)
    user_id: Mapped[int] = mapped_column(BigInteger, ForeignKey("users.user_id"))
    content_id: Mapped[int] = mapped_column(BigInteger, ForeignKey("comments.comment_id"))
    created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow)
